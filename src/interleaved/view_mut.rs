...
///
/// let block = AudioBlockInterleavedViewMut::from_slice(&mut data, 2);
///
...
mod tests {
    ...
    fn test_samples() {
        ...
        let mut block = AudioBlockInterleavedViewMut::<f32>::from_slice(&mut data, 2);
    ...
    fn test_from_slice() {
        ...
        let block = AudioBlockInterleavedViewMut::<f32>::from_slice(&mut data, 2);
